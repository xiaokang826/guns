...
public class GunsGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void globalConfig() {
        globalConfig.setOutputDir("D:\\blabla");//写自己项目的绝对路径,注意具体到java目录
    ...
    protected void dataSourceConfig() {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://10.0.0.117:3306/spring_boot?characterEncoding=utf8");
    }
...
//        packageConfig.setXml("com.stylefeng.guns.admin.common.persistence.dao.mapping");
        packageConfig.setEntity("cmodel");
        packageConfig.setMapper("cdao");
        packageConfig.setXml("cmapping");
    }

    protected void contextConfig() {
//        contextConfig.setProPackage("com.stylefeng.guns.admin");
//        contextConfig.setCoreBasePackage("com.stylefeng.guns.core");
        contextConfig.setProPackage("admin");
        contextConfig.setCoreBasePackage("core");
        contextConfig.setBizChName("测试");
        contextConfig.setBizEnName("test");
        contextConfig.setModuleName("item_test");
//        contextConfig.setProjectPath("D:\\CommonFile\\Guns");//写自己项目的绝对路径
        contextConfig.setProjectPath("D:\\blabla\\piapia");//写自己项目的绝对路径
        contextConfig.setEntityName("ItemTest");
