...
public class ServiceConfig {
    ...
    public void init() {
        ...
        imports.add(contextConfig.getProPackage() + ".modular." + contextConfig.getModuleName().replaceAll("/",".") + ".service.I" + contextConfig.getBizEnBigName() + "Service");
        ...
        this.servicePathTemplate = "\\src\\main\\java\\" + contextConfig.getProPackage().replaceAll("\\.", "\\\\") + "\\modular\\" + contextConfig.getModuleName().replaceAll("/",".") + "\\service\\I{}Service.java";
        this.serviceImplPathTemplate = "\\src\\main\\java\\" + contextConfig.getProPackage().replaceAll("\\.", "\\\\") + "\\modular\\" + contextConfig.getModuleName().replaceAll("/",".") + "\\service\\impl\\{}ServiceImpl.java";
        this.packageName = contextConfig.getProPackage() + ".modular." + contextConfig.getModuleName().replaceAll("/",".") + ".service";
    }
