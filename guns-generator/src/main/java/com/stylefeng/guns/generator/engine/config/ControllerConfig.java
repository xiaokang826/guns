...
public class ControllerConfig {
    ...
    public void init() {
        ...
        imports.add(contextConfig.getProPackage() + ".modular." + contextConfig.getModuleName().replaceAll("/",".") + ".service" + ".I" + contextConfig.getEntityName() + "Service");
        this.imports = imports;
        this.packageName = contextConfig.getProPackage() + ".modular." + contextConfig.getModuleName().replaceAll("/",".") + ".controller";
